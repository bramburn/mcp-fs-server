...
import CommandPaletteTest from "./CommandPaletteTest.js";
...
describe("CommandPaletteTest (React)", () => {
  ...
  it("renders header and IPC status", () => {
    ...
    expect(screen.getByText("Command Palette Test")).toBeInTheDocument();
  ...
  it("invokes ipc.sendCommand when a command item is selected", async () => {
    ...
    const [method, scope, params] = (
      ipc.sendCommand as ReturnType<typeof vi.fn>
    ).mock.calls[0];
